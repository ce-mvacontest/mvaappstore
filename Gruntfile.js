// Generated on 2014-09-16 using generator-ionic 0.5.4
'use strict';

var _ = require('lodash');
var path = require('path');
var cordova = require('cordova');
//var spawn = require('child_process').spawn; bug in windows, use win-spawn from npm install win-spawn instead
...
module.exports = function (grunt) {
    ...
    ngconstant: {
      ...
      development: {
        constants: {
          ENV: {
            name: 'development',
            url: 'http://mvaappstore.com/',
            api: 'http://mvaappstore.com/api/'
          }
        }
      },
      production: {
  ...
  _.functions(cordova).forEach(function (name) {
    ...
    grunt.registerTask(name, function () {
      ...
      var done = this.async();
      var exec = process.platform === 'win32' ? 'cordova.cmd --release' : 'cordova --release';
